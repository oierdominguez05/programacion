package Examenes.Examen1_2ªev.EmpresaAgroalimentaria;
...
public class main {
	...
	public static void main(String[] args) {
		 ...
		 * llevar la información de la composición del aire con que fue congelado (% de
		 * nitrógeno, % de oxígeno, % de dióxido de carbono y % de vapor de agua). Los
		 ...
		 * de congelación empleado y del tiempo de exposición al nitrógeno expresada en
		 * segundos.
		 */
