package unidad6Clases.CuentaCorriente.controlador;
import java.util.Scanner;

import unidad6Clases.CuentaCorriente.modelo.Cuenta;
import unidad6Clases.CuentaCorriente.vista.VistaCuenta;
...
public class ControladorCuenta {
	...
	public void ingresar(String dni, double cantidad) {
		modelo.addSaldo(modelo.getSaldo() + cantidad);
